...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-car':
				// YET ANOTHER CASE OF GIRLFRIEND CODE
			...
			case 'gf-pixel':
				// GOOD GOD YOU GUYS LIKE THE GF HUH
			...
			case 'frub':
				...
				animation.addByPrefix('singRIGHT', 'frub right', 24);
				animation.addByPrefix('singDOWN', 'frub down', 24);
				animation.addByPrefix('singLEFT', 'frub left', 24);

				addOffset('idle');
				addOffset("singUP", 60, 350);
				addOffset("singRIGHT", -70, 4);
				addOffset("singLEFT", 272, 8);
