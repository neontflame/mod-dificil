...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var check_changeSpeed:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		stepperSectionSpeed = new FlxUINumericStepper(10, 330, 0.1, 1, 0.1, 10, 1);
		stepperSectionSpeed.value = _song.speed;
		...
		check_changeSpeed = new FlxUICheckBox(10, 310, null, null, 'Change scroll speed', 100);
		check_changeSpeed.name = 'check_changeSpeed';
		...
		tab_group_section.add(check_changeSpeed);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		if (id == FlxUICheckBox.CLICK_EVENT)
		{
			...
			switch (label)
			{
				...
				case 'Change scroll speed':
					_song.notes[curSection].changeSpeed = check.checked;
					FlxG.log.add('get the speed shit FASTER or slower');
				case "Alt Animation":
		...
		else if (id == FlxUINumericStepper.CHANGE_EVENT && (sender is FlxUINumericStepper))
		{
			...
			else if (wname == 'section_speed')
			{
				if (nums.value <= 0)
					nums.value = 0;
				_song.notes[curSection].speed = nums.value;
			}
		}
	...
	function updateSectionUI():Void
	{
		...
		check_changeSpeed.checked = sec.changeSpeed;
		stepperSectionSpeed.value = sec.speed;
	...
	function updateGrid():Void
	{
		...
		if (_song.notes[curSection].changeSpeed && _song.notes[curSection].speed > 0)
		{
			_song.speed = _song.notes[curSection].speed;
			FlxG.log.add('CHANGED SPEED!');
		}
		else
		{
			// get last speed
			var leSpeeds:Float = _song.speed;
			for (i in 0...curSection)
				if (_song.notes[i].changeSpeed)
					leSpeeds = _song.notes[i].speed;
			_song.speed = leSpeeds;
		}
